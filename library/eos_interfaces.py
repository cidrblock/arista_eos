...
from ansible.module_utils.network.resources.interfaces import module_config
from ansible.module_utils.network.eos.providers.cli.config import interfaces
