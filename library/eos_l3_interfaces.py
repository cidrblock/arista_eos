...
from ansible.module_utils.network.resources.l3_interfaces import module_config
from ansible.module_utils.network.eos.providers.cli.config import l3_interfaces
